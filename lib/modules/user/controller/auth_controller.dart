...
class AuthController {
  ...
  Future<Response> login(Request request) async {
    try {
      ...
      return Response.forbidden({'message': 'Usuario ou senha invalidos'});
    } catch (e, s) {
  ...
  Future<Response> confirmLogin(Request request) async {
    try {
      ...
      final inputModel = UserConfirmInputModel(
          userId: user, accesToken: token, data: await request.readAsString());
      ...
      log.error('Erro parametros obrigatorios nao informados', e, s);
      return Response(400, body: jsonEncode(e.errors));
    } catch (e, s) {
